...
const PreOrder = () => {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["getShoes", "preOrder", limit, discount],
        queryFn: async () => {
            const res = await axios.get(
                `/products?&limit=${limit}&preOrder=${true}`
            );
            return res.data;
        },
    ...
    return (
        ...
        />
              ...
              <h1 className='lg:text-2xl text-2xl font-semibold text-start mb-2'>Taking Pre-Orders For </h1>
